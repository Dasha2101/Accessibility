...
const Panel = ({ results }) => {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('p', {
        children:
          '\u0412\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u0441\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0432\u0430\u0448\u0438 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B \u0432 \u0443\u0434\u043E\u0431\u043D\u043E\u043C \u0434\u043B\u044F \u0432\u0430\u0441 \u0444\u043E\u0440\u043C\u0430\u0442\u0435',
      }),
      _jsxs('div', {
        className: 'button-group',
        children: [
          _jsx(Button, { children: 'Export JSON', onClick: exportJSON }),
          _jsx(Button, { children: 'Export CSV', onClick: exportCSV }),
          _jsx(Button, { children: 'Export PDF', onClick: exportPDF }),
        ],
      }),
    ],
  });
